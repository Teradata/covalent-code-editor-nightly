(function (global, factory) {
    ...
    (global = global || self, factory((global.covalent = global.covalent || {}, global.covalent['code-editor'] = {}), global.ng.core, global.ng.forms, global.rxjs, global.rxjs.operators, global.monacoEditor, global.ng.common));
}(this, (function (exports, core, forms, rxjs, operators, monacoEditor, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TdCodeEditorComponent = /** @class */ (function () {
        ...
        function () {
            if (this._language) {
                monacoEditor.editor.setModelLanguage(this._editor.getModel(), this._language);
        ...
        function (language) {
            ...
            if (this._componentInitialized) {
                ...
                monacoEditor.languages.register({ id: language.id });
                monacoEditor.languages.setMonarchTokensProvider(language.id, {
                    tokenizer: {
                        root: language.monarchTokensProvider,
                    },
                });
                // Define a new theme that constains only rules that match this language
                monacoEditor.editor.defineTheme(language.customTheme.id, language.customTheme.theme);
                this._theme = language.customTheme.id;
                monacoEditor.languages.registerCompletionItemProvider(language.id, {
        ...
        function () {
            ...
            this._editor = monacoEditor.editor.create(containerDiv, Object.assign({
                value: this._value,
