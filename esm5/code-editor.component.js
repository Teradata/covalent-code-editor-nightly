    ...
    function (language) {
        ...
        if (this._componentInitialized) {
            if (this._webview) {
                ...
                this.editorConfigurationChanged.emit();
                this._registeredLanguagesStyles = tslib_1.__spread(this._registeredLanguagesStyles, [css]);
            }
        }
    };
